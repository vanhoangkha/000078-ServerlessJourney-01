...
pre : " <b> 2.1 </b> "
---
1. Mở bảng điều khiển [AWS Lambda](https://ap-southeast-1.console.aws.amazon.com/lambda/home?region=ap-southeast-2#/discover) 
...
- **DES_BUCKET**: tên của S3 bucket lưu ảnh sau khi thay đổi, **book-image-resize-store**.
